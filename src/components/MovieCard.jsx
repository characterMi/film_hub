import { Box, Grid, Grow, Rating, Tooltip, Typography, useMediaQuery } from '@mui/material';
            ...
            <Grow in key={i} timeout={(i + 1) * 250}>
                ...
                >
                    <Box
                        ...
                        src={movie?.poster_path ? `https://image.tmdb.org/t/p/w500/${movie?.poster_path}` : 'https://dummyimage.com/200x300'}
                        alt={movie?.title}
                    />
                    <Box
                        sx={{
                    ...
                    >
                        <Typography color={theme.palette.mode === 'light' ? "#000" : '#fff'} sx={{ textOverflow: 'ellipsis', width: '100%', overflow: 'hidden', whiteSpace: 'nowrap', fontSize: { xs: '20px', lg: '28px' } }}>
                            {movie?.title}
                        </Typography>
                        ...
                        <Typography color={theme.palette.mode === 'light' ? "#000" : '#fff'} sx={{ fontSize: '14px', my: "1rem" }}>
                            {!isMobile && movie?.overview?.length > 200 ? `${movie?.overview?.slice(0, 200)}...` : movie?.overview}
                        </Typography>
                    </Box>
                </Box>
            </Grow>
